...
from flask import Response, Flask, flash, request, redirect, url_for, render_template

from picture import PictureResizer
...
def process_image(filename: str) -> None:
    ...
    modified = PictureResizer(
        os.path.join("static/upload/", filename), filename
    )
